...
const MUDREX_API = 'https://trade.mudrex.com/fapi/v1/futures/positions';
...
export async function GET() {
  try {
    ...
    return NextResponse.json({ error: 'Failed to fetch positions', details: String(err) }, { status: 500 });
  }
}
